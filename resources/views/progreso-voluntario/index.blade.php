										...
										<td >{{ $progresoVoluntario->id_usuario }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('progreso-voluntario.destroy', $progresoVoluntario->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('progreso-voluntario.show', $progresoVoluntario->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('progreso-voluntario.edit', $progresoVoluntario->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
