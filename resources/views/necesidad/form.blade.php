    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="tipo" id="tipo" class="form-control @error('tipo') is-invalid @enderror" required>
                ...
                <option value="Equipamiento" {{ old('tipo', $necesidad?->tipo) == 'Equipamiento' ? 'selected' : '' }}>Equipamiento</option>
                <option value="Recursos" {{ old('tipo', $necesidad?->tipo) == 'Recursos' ? 'selected' : '' }}>Recursos</option>
                <option value="Infraestructura" {{ old('tipo', $necesidad?->tipo) == 'Infraestructura' ? 'selected' : '' }}>Infraestructura</option>
