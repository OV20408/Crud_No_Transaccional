            ...
            <div class="card card-outline card-primary">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="cursoNombre" maxlength="100" placeholder="Ej: Primeros Auxilios Básicos">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="cursoDescripcion" rows="3" maxlength="250" placeholder="Describe brevemente el contenido del curso"></textarea>
                </div>

                <hr>

                <div class="form-group">
                  <label>Etapas del Curso <span class="text-danger">*</span> <span class="text-muted">(mínimo 3)</span></label>
                  <div class="input-group mb-3">
                    <input type="text" class="form-control" id="etapaNombre" maxlength="80" placeholder="Ej: Evaluación inicial del paciente">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (cursos.length > 0) {
    ...
    alert('No hay curso para editar');
  }
}
