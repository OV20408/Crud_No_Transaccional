										...
										<td >{{ $capacitacion->nombre }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('capacitaciones.destroy', $capacitacion->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('capacitaciones.show', $capacitacion->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('capacitaciones.edit', $capacitacion->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
