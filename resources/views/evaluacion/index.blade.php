										...
										<td >{{ $evaluacion->id_universidad }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('evaluacion.destroy', $evaluacion->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('evaluacion.show', $evaluacion->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('evaluacion.edit', $evaluacion->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
